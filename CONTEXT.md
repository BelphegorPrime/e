...
The next seven terms are the vocabulary of ADR-0013 (proposed; implemented through ticket 08: role contract, broker + skill, `Git.merge`, checkpoint, artifact sync, the host side that launches siblings, the merge-back, and the end-to-end test):
