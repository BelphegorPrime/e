...
The next seven terms are the vocabulary of ADR-0013 (proposed; implemented through ticket 06: role contract, broker + skill, `Git.merge`, checkpoint, artifact sync, and the host side that launches siblings; the merge-back of ticket 07 is not):
