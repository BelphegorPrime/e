# 31 - Egress hardening: allow-list provider + MCP endpoints for run containers

**Status:** Done (closed 2026-09-07).

**GitHub:** [#27](https://github.com/BelphegorPrime/e/issues/27)
...
deferred gap). The harness agent only _needs_ to reach its provider base URL
